...
class PilotTrainingReportsTest extends TestCase
{
    ...
    #[Test]
    public function instructor_can_access_own_training_reports()
    {
    ...
    #[Test]
    public function instructor_cannot_access_other_instructors_reports()
    {
        $training = PilotTraining::factory()->create([
            'user_id' => User::factory()->create(['id' => 10000005])->id,
        ]);
        ...
        $instructor2 = User::factory()->create(['id' => 10000401]);
        $instructor2->groups()->attach(4, ['area_id' => 2]);
        ...
        $this->actingAs($instructor2)->assertFalse(Gate::inspect('view', $report, [$training->user, $report])->allowed());
    }
    ...
    #[Test]
    public function instructor_cannot_access_other_instructors_draft_report()
    {
        $training = PilotTraining::factory()->create([
            'user_id' => User::factory()->create(['id' => 10000042])->id,
        ]);
        ...
        $instructor2 = User::factory()->create(['id' => 10000081]);
        $instructor2->groups()->attach(4, ['area_id' => 2]);
        ...
        $training->instructors()->attach($instructor, ['expire_at' => now()->addYear()]);
        $this->actingAs($instructor2)->assertFalse(Gate::inspect('view', $report)->allowed());
    }
}